...
# ============================
SESSION = environ.get('SESSION', 'RJ_Movie_Search')   # Session name for the bot
...
BOT_TOKEN = environ.get('BOT_TOKEN', "8728991198:AAEXo0-0MrOzcJxwjgFLf-KYAFxdDLq6nv8")    # Bot token from @BotFather
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003908307047').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003908307047'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1004447516927'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1004447516927'))  # Premium logs channel id
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1004358264076')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1004358264076')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/dubbedmoviez_77')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "1004292676722")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1004358264076'))  # Notification of sent to your channel
...
# ============================
IS_VERIFY = is_enabled(environ.get('IS_VERIFY', 'False'), True)  # Verification On (True) / Off (False)
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/Thecinemacircle10/55")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/Thecinemacircle10/55")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/Thecinemacircle10/55")   # Third tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+0j544bRsm7E4OWRl') # Group link for the bot
...
# ============================
ULTRA_FAST_MODE = is_enabled(environ.get('ULTRA_FAST_MODE', "True"), False) # Set to True for fast search, False for original search
...
MAX_LIST_ELM = int(environ.get("MAX_LIST_ELM", None) or 10) or None # Maximum number of elements in a list (default: None, no limit)
...
MAINTENANCE = is_enabled(environ.get('MAINTENANCE', "True"), True)
